...
cp -Rp ~/Documents/ypv/frontend/app/assets/PL3rWPUEsL-MFOpLQ1FCZlavfKZK16Q8Cq ~/Desktop/dist/mac-x64/dist.app/Contents/Frameworks/nwjs\ Helper.app/Contents/MacOS/assets/
